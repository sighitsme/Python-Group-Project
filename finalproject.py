# -*- coding: utf-8 -*-
"""
Created on Sun Nov 27 11:28:15 2022
...
if question_user == "1":
  ...
  if question1 == "y" and question2 == "y" and question3 == "y":
      ...
      if question4 == "y" and question5 == "n":
          ...
          print("This weekend I am going camping with" , sillyname1 + " I packed my lantern, sleeping bag, and", noun1 + 
        " I am so", adjectivefeeling1 + "to",  verb1 +  "in a tent. I am", adjectivefeeling2 + "we might see a", animal1 + ", they are kind of dangerous. We are going to hike, fish, and", verb2 + 
      ...
      if question4 == "y":
          ...
          print("Select the type of bread you want to use. Many prefer the taste of", color1 + " bread, while others prefer", noun1 + 
        " bread because it is healthy. Then, choose the flavor of Jam/Jelly. I personally prefer", sillyword1 + " jam, but you can use whatever you want. Next, choose the type of peanut butter–either", adjective1 + " or", adjective2 + " . Take out", number1 + 
        " slice(s) of bread and use a", noun2 + " to", verb1 + " the jam all over one of the pieces of bread. Now", verb2 + " the peanut butter on the other piece of bread. Put them together, and you have a PB&J", noun3 ) 
      else:
          #Weekend is selected
      ...
      if question4 == "y":
          ...
          print("Argh! I just had the absolutely worst day at the barber. First, I was running late for my 4:00pm appointment because a", noun1 + 
        " got hit by a", noun2 + " on the freeway, causing major traffic. Then, when I finally arrive at the shop, I find my slot has been taken by some", adjective1 + " man. ´Um excuse me?´ I said, ´You’re in my spot´. The man looked up at me with",
        adjective2 + " eyes, and drawled ´I was here first. Wait your turn.´ Fuming, I turned to the barber: ", exclamation1 + " ! ")
      else:
      ...
      if question4 == "y":
          ...
          print("Jenny Kowalski looked at the warped" , noun1 + " in her hands and felt angry. She walked over to the window and reflected on her" , adjective1 + 
        " surroundings. She had always loved picturesque", noun2 + " with its calm, cloudy cliffs. It was a place that encouraged her tendency to feel", adjective2 + 
        " . Then she saw something in the distance, or rather someone. It was the figure of Harry Blacksmith. Harry was a lovable, handsome", occupation1 + 
        " . Jenny gulped. She glanced at her own reflection. Her friends saw her as a", adjective3 + 
        " weirdo. The wind blew like rampaging", animal1 +  ", making Jenny anxious. As Jenny stepped outside and Harry came closer, she could see the", adjective4 + " smile on his face. ´I am here because I want´", noun3 + 
        " ´, Harry bellowed, in a patient tone. He slammed his fist against Jenny's chest, with the force of", number1 + " .I", verb1 + 
        "  love you, Jenny Kowalski. Jenny looked back, even more anxious. ´Harry, get out of my house,´ she replied. They looked at each other with", adjective5 + 
        " feelings like two", adjective6 + noun4 + ". Suddenly, Harry lunged forward and tried to", verb2 + " Jenny in the face. She", verb3 + " Jenny Kowalski went back inside and made herself a nice glass of port.")
  ...
  max_storyranking = max(storyranking, key=len)
  
  if max_storyranking == story1rank:
       #Camping story is chosen
       sillyname1 = input("Enter a silly name: ")
       noun1 = input("Enter an noun: ")
       adjectivefeeling1 = input("Enter adjective that is a feeling: ")
  ...
  elif max_storyranking == story2rank:
      alphabet1 = input("Enter a letter of the alphabet: ")
      adjective1 = input("Enter an adjective: ")
      adjective2 = input("Enter an adjective: ")
      noun2 = input("Enter a noun: ")
